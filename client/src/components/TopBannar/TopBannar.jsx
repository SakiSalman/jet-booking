...
const TopBannar = ({bgImage, title, breadCumb}) => {
  return (
    <section className=" max-h-[320px] h-[400px] flex items-center mt-[-90px] sm:mt-[-90px] text-white bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})` }}>
