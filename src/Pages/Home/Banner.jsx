        ...
        {/* <section className='py-20'>
            <div className="container mx-auto">
                <form action="" className='flex justify-between items-center gap-4'>
                    ...
                    >
                      First Name<i class='bx bx-child'></i>
                    </label>
                    <input
                      type="text"
                      id="first-name"
          ...
          {/* Form End */}
            ...
            {/* <!-- Banner Area Start--> */}
      <section class="py-36 bg-black flex items-center w-full h-96 text-white bg-no-repeat bg-cover relative">
        <img className='w-full h-96 absolute mix-blend-overlay object-cover bg-blend-darken' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/world-map-5.svg" alt="" />
        ...
        <section className='py-16'>
          ...
          <div className="container mx-auto sm:flex flex-row justify-between sm:flex-row gap-4">
            <div className="img_div sm:basis-1/3 basis-1/1 flex items-center">
              <img className='w-[100%] px-3 sm:px-0 sm:pb-0 pb-7 mx-0 sm:mx-12 z-50 center shadow-2xl' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/04/corporate-jet-1-small.jpg" alt="" />
            </div>
            ...
            <div className="card-row sm:flex  justify-between sm:pl-16 flex-row">
              <div className="card-1">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-5.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
              <div className="card-1 pt-10 sm:pt-0">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-2.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
            </div>
            <div className="card-row sm:flex  justify-between sm:pl-16 flex-row pt-10">
              <div className="card-1">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-4.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
              <div className="card-1 pt-10 sm:pt-0">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-1.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
            </div>
            <div className="card-row sm:flex  justify-between sm:pl-16 flex-row pt-10">
              <div className="card-1 pb-3">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-6.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
              <div className="card-1 pt-10 sm:pt-0">
                <img className='w-12 pb-3' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/Asset-3.svg" alt="" />
                <h3 className='text-[22px] font-bold mb-4'>LUXURY AND COMFORT</h3>
                <p className='sm:w-2/3 text-[18px]'>Flying should be a pleasure and we’ll make your charter experience as luxurious and comfortable as possible.</p>
              </div>
            </div>
        ...
        <div className='luxury sm:flex flex-row'>
          <div className="luxury-card text-center mx-auto px-4 basis-1/4">
            <img className='mx-auto w-[100%]' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/feather-plane-1-300x300.jpg" alt="" />
            <h3 className='text-lg font-bold mt-8'>PRIVATE JET</h3>
            <p className='mx-2 text-center mt-2 text-[20px] text-[#a8987e]'> <a className='' href="#">An Air Curly private charter guarantees your privacy</a> </p>
          </div>
          <div className="luxury-card text-center mx-auto px-4 basis-1/4 py-10 sm:py-0">
            <img className='mx-auto w-[100%]' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/light-jet-300x300.jpg" alt="" />
            <h3 className='text-lg font-bold mt-8'>PRIVATE JET</h3>
            <p className='mx-2 text-center mt-2 text-[20px] text-[#a8987e]'> <a className='' href="#">An Air Curly private charter guarantees your privacy</a> </p>
          </div>
          <div className="luxury-card text-center mx-auto px-4 basis-1/4">
            <img className='mx-auto w-[100%]' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/helicopter-1-300x300.jpg" alt="" />
            <h3 className='text-lg font-bold mt-8'>PRIVATE JET</h3>
            <p className='mx-2 text-center mt-2 text-[20px] text-[#a8987e]'> <a className='' href="#">An Air Curly private charter guarantees your privacy</a> </p>
          </div>
          <div className="luxury-card text-center mx-auto px-4 basis-1/4 py-10 sm:py-0">
            <img className='mx-auto w-[100%]' src="https://demo.curlythemes.com/private-jet/wp-content/uploads/sites/27/2018/03/large-plane-1-300x300.jpg" alt="" />
            <h3 className='text-lg font-bold mt-8'>PRIVATE JET</h3>
            <p className='mx-2 mt-2 text-center text-[20px] text-[#a8987e]'> <a className='' href="#">An Air Curly private charter guarantees your privacy</a> </p>
          </div>  
        </div>
          </div>
        </section>
